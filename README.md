...
#### Backend
Using simple go [gin](https://github.com/gin-gonic/gin) http server with a webscraper using [colly](https://github.com/gocolly/colly). Dockerfile is for the webserver.
